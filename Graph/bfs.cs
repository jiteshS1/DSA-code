...
- Variables
    - Queue
    - Visited nodes array of nodes length.
    - Adjancency list storing neighbour nodes for each node.
- Enqueue 1st node in queue
- Loop until queue is empty
    - Take node by Dequeue
    - If node is not visited
        - Mark node as visited in array
        - Print Node --- It will print all nodes
        - Push neighbour nodes into queue (Check from adj. list) using loop
